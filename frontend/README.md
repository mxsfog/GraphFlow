...
- редактирование label, type, shape, периода `created_at`/`ended_at`, image и properties;
...
- фильтры по уровню, статусу, региону, организации и году;
- сворачивание отдельной иерархической ветви непосредственно на узле;
- подсветка одинаковых узлов в нескольких картах;
- карточка узла с описанием, источником, статусом и режимом план/факт;
- отображение периода актуальности на узле и в его карточке;
- динамическая легенда типов узлов и связей;
- сохранение представлений в OrientDB;
