...
- вложенные группы с постоянным состоянием сворачивания;
- агрегирование внешних ребер свернутой группы;
- сохранение и повторное добавление шаблонов графа.
...
Тесты проверяют раскладки, циклические компоненты, вложенные группы, сворачивание дочерних узлов и агрегирование ребер.
