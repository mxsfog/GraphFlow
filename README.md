...
- `GraphDocument`, `GraphNode` - пользовательский или декомпозированный граф;
...
- редактирование подписи, формы, даты создания, изображения и properties;
...
- раскладки Follow, Timeline и Structure с обработкой циклов;
