CREATE CLASS SearchQuery EXTENDS V;
CREATE PROPERTY SearchQuery.query STRING;
CREATE PROPERTY SearchQuery.created_at DATETIME;
CREATE PROPERTY SearchQuery.period STRING;
CREATE PROPERTY SearchQuery.source STRING;
...
CREATE PROPERTY NewsLink.seendate STRING;
CREATE PROPERTY NewsLink.domain STRING;
CREATE PROPERTY NewsLink.language STRING;
...
CREATE CLASS FoundBy EXTENDS E;
